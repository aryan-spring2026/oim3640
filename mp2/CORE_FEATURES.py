...
def suggest_deck_order(song_files):
    ...
    for profile in profiles:
        if profile["energy"] == "High Energy":
            high_energy.append(profile["filename"])
        elif profile["energy"] == "Transition Song":
            transition.append(profile["filename"])
        elif profile["energy"] == "Low Energy":
            low_energy.append(profile["filename"])
        else:
            neutral.append(profile["filename"])
